  ...
  return {
    ...
    configureServer(server) {
      ...
      server.middlewares.use((request, response, next) => {
        ...
        if (request.headers["next-router-prefetch"] !== void 0 || request.headers["x-middleware-prefetch"] === "1" || [request.headers.purpose, request.headers["sec-purpose"]].some(
          (value) => typeof value === "string" && value.split(/[;,]/).some((part) => part.trim().toLowerCase() === "prefetch")
        )) {
...
function removeHeader(request, name) {
